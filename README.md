...
## Update
안녕하십니까, 김주철 교수님의 인공지능과금융공학을 수강하고 있는 2023145010 오승진입니다.
본 삼성전자 자동매매 프로그램의 업데이트 내용과 매매기록을 이곳에 기재하겠습니다.
깃헙에는 개인정보 API를 올리면 이걸 본 누군가가 악용하여 거래를 할 수 있으므로, 올리지 않았습니다.
